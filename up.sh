...
FRONTEND_URL="https://${HOST_PREFIX:-}dms.${DOMAIN_SUFFIX:-localhost}"
BACKEND_API_URL="https://${HOST_PREFIX:-}dms-api.${DOMAIN_SUFFIX:-localhost}/api/v1"
DEFAULT_BACKEND_PORT="8001"
DEFAULT_FRONTEND_PORT="5174"
SKIP_TABLES_SUFFIX_SOURCE=true

setup_frontend_env() {
    upsert_env_var frontend/.env VITE_API_URL            "${VITE_API_URL:-https://${HOST_PREFIX:-}dms-api.${DOMAIN_SUFFIX:-localhost}/api/v1}"
