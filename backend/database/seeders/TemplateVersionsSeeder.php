    ...
    private function buildPublishedSnapshotPayload(
        ...
        return [
            'template' => [
                ...
                'delivery_deadline' => $headTemplate['delivery_deadline'] ?? null,
                'document_delivery_deadline' => $headTemplate['document_delivery_deadline'] ?? null,
                ...
                'created_by' => (string) ($headTemplate['created_by'] ?? ''),
                'review_stages' => (int) ($headTemplate['review_stages'] ?? 0),
                'review_mode' => (string) ($headTemplate['review_mode'] ?? 'parallel'),
                'document_review_mode' => $headTemplate['document_review_mode'] ?? ($headTemplate['review_mode'] ?? 'parallel'),
                'status' => 'published',
