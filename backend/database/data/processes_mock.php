...
$processes[] = ['id' => $uid('010101'), 'code' => 'PC01.01', 'name' => 'Actividades extraescolares y complementarias',              'alias' => 'Activ. extraescolares',   'icon' => 'calendar',         'color' => $hsl(180, 55, 45), 'process_parent_id' => $pc01];
...
$processes[] = ['id' => $uid('010300'), 'code' => 'PC03',    'name' => 'Orientación educativa y profesional',                       'alias' => 'Orientación educativa',   'icon' => 'compass',          'color' => $hsl(206, 60, 45), 'process_parent_id' => null];
...
$processes[] = ['id' => $uid('010401'), 'code' => 'PC04.01', 'name' => 'Atención domiciliaria',                                     'alias' => 'Atención domiciliaria',   'icon' => 'home',             'color' => $hsl(220, 55, 55), 'process_parent_id' => $uid('010400')];
...
$processes[] = ['id' => $uid('010700'), 'code' => 'PC07',    'name' => 'Evaluación del aprendizaje',                                'alias' => 'Evaluación aprendizaje',  'icon' => 'clipboard-check',  'color' => $hsl(242, 60, 55), 'process_parent_id' => null];
$processes[] = ['id' => $uid('010800'), 'code' => 'PC08',    'name' => 'Formación en empresas',                                     'alias' => 'Formación en empresas',   'icon' => 'briefcase',        'color' => $hsl(248, 60, 55), 'process_parent_id' => null];
$processes[] = ['id' => $uid('010900'), 'code' => 'PC09',    'name' => 'Igualdad y convivencia',                                    'alias' => 'Igualdad y convivencia',  'icon' => 'heart',            'color' => $hsl(254, 60, 55), 'process_parent_id' => null];
...
$processes[] = ['id' => $uid('020100'), 'code' => 'PS01',    'name' => 'Gestión administrativa',                                    'alias' => 'Gestión administrativa',  'icon' => 'folder',           'color' => $hsl(28,  65, 50), 'process_parent_id' => null];
...
$processes[] = ['id' => $uid('020104'), 'code' => 'PS01.04', 'name' => 'Certificación, titulación y expedientes',                   'alias' => 'Certificación / títulos', 'icon' => 'award',            'color' => $hsl(44,  60, 50), 'process_parent_id' => $uid('020100')];
$processes[] = ['id' => $uid('020105'), 'code' => 'PS01.05', 'name' => 'Certificados de aprovechamiento FPA',                       'alias' => 'Certif. aprovech. FPA',   'icon' => 'award',            'color' => $hsl(48,  60, 50), 'process_parent_id' => $uid('020100')];
...
$processes[] = ['id' => $uid('020206'), 'code' => 'PS02.06', 'name' => 'Alumnado en prácticas',                                     'alias' => 'Alumnado en prácticas',   'icon' => 'briefcase',        'color' => $hsl(350, 60, 55), 'process_parent_id' => $uid('020200')];
$processes[] = ['id' => $uid('020207'), 'code' => 'PS02.07', 'name' => 'Prevención de riesgos laborales',                           'alias' => 'Prevención de riesgos',   'icon' => 'shield',           'color' => $hsl(346, 60, 50), 'process_parent_id' => $uid('020200')];
...
$processes[] = ['id' => $uid('020301'), 'code' => 'PS03.01', 'name' => 'Mantenimiento y renovación de equipos',                     'alias' => 'Mant. y renov. equipos',  'icon' => 'wrench',           'color' => $hsl(336, 55, 55), 'process_parent_id' => $uid('020300')];
