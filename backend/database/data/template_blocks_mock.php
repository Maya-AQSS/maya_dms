...
$__templateBlockRows = array_merge([
    ...
    [
        ...
        'title' => 'Introducción',
        'description' => $seedDoc([$seedP('Sección: Introducción. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 10,
    ],
    [
        ...
        'template_id' => '33333333-3333-3333-3333-333333333320',
        'title' => 'Competencias profesionales, personales y sociales',
        'description' => $seedDoc([$seedP('Sección: Competencias profesionales, personales y sociales. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 20,
    ],
    [
        ...
        'description' => $seedDoc([$seedP('Sección: Resultados de aprendizaje. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 30,
    ],
    [
        ...
        'description' => $seedDoc([$seedP('Sección: Criterios de evaluación. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 40,
    ],
    [
        ...
        'template_id' => '33333333-3333-3333-3333-333333333320',
        'title' => 'Contenidos',
        'description' => $seedDoc([$seedP('Sección: Contenidos. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 50,
    ],
    [
        ...
        'description' => $seedDoc([$seedP('Sección: Unidades didácticas. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 60,
    ],
    [
        ...
        'template_id' => '33333333-3333-3333-3333-333333333320',
        'title' => 'Metodología didáctica aplicada',
        'description' => $seedDoc([$seedP('Sección: Metodología didáctica aplicada. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 70,
    ],
    [
        ...
        'template_id' => '33333333-3333-3333-3333-333333333320',
        'title' => 'Evaluación',
        'description' => $seedDoc([$seedP('Sección: Evaluación. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 80,
    ],
    [
        ...
        'template_id' => '33333333-3333-3333-3333-333333333320',
        'title' => 'Actividades didácticas complementarias',
        'description' => $seedDoc([$seedP('Sección: Actividades didácticas complementarias. Rellena el contenido siguiendo el currículo oficial del módulo.')]),
        'default_content' => $seedDoc([$seedP('')]),
        'block_state' => 'editable',
        'sort_order' => 90,
    ],
