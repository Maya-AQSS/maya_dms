...
class StoreTemplateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'document_delivery_deadline' => ['required', 'date', 'after_or_equal:today', 'after_or_equal:delivery_deadline'],
            'study_type_id' => [
            ...
            'document_review_mode' => ['sometimes', 'string', 'in:sequential,parallel'],
    ...
    public function toCreateDto(): CreateTemplateDto
    {
        ...
        return new CreateTemplateDto(
            ...
            documentDeliveryDeadline: isset($v['document_delivery_deadline']) ? (string) $v['document_delivery_deadline'] : null,
            ...
            documentReviewMode: $v['document_review_mode'] ?? null,
        );
    }
}
