...
use App\Repositories\Eloquent\CommentReadRepository;
...
use App\Services\ThemeRenderService;
...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(TemplateReviewerRepositoryInterface::class, TemplateReviewerRepository::class);
        ...
        $this->app->bind(TemplatePdfServiceInterface::class, TemplatePdfService::class);
        ...
        $this->app->bind(ThemeRenderServiceInterface::class, ThemeRenderService::class);
        $this->app->bind(ThemePdfServiceInterface::class, ThemePdfService::class);
