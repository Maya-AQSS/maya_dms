...
final readonly class TemplateDto
{
    ...
    public static function fromModel(Template $m): self
    {
        ...
        return new self(
            ...
            documentDeliveryDeadline: $m->document_delivery_deadline?->toIso8601String(),
            ...
            latestPublishedName: $m->presentation()->latestPublishedName,
            latestPublishedAt: IsoTimestamp::formatOptional($m->presentation()->latestPublishedAt),
