 ...
 * el ámbito académico y los equipos preferentes vienen de la BD (FDW / tablas mock);
 * si el servicio cae en fallback JWT, esas listas equivalen a los claims del token.
 *
