...
describe('filterDocumentsByCascade', () => {
 ...
 const r = filterDocumentsByCascade(docs,
 { studyTypeId:'', studyId:'', moduleId:'m2' },
 hierarchy
 );
 ...
 const r = filterDocumentsByCascade(docs,
 { studyTypeId:'', studyId:'s1', moduleId:'' },
 hierarchy
 );
 ...
 const r = filterDocumentsByCascade(docs,
 { studyTypeId:'st1', studyId:'', moduleId:'' },
 hierarchy
 );
 ...
 const r = filterDocumentsByCascade(docs,
 { studyTypeId:'missing', studyId:'', moduleId:'' },
 hierarchy
 );
 expect(r).toEqual([]);
 });
