...
export function TemplatesContent() {
 ...
 {actionError && (<div className="rounded-lg border border-primary/30 bg-primary/5 px-4 py-3 text-sm text-on-surface flex justify-between gap-4">
 ...
 {actionInfo && (<div className="rounded-lg border border-secondary/30 bg-secondary/5 px-4 py-3 text-sm text-on-surface flex justify-between gap-4">
 ...
 <div className="bg-surface-container-low rounded-lg border border-outline shadow-card p-5 space-y-3">
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 border-t border-outline/50">
 <div>
 ...
 {loading && templates.length === 0 ? (<p className="text-sm text-on-surface-muted">Cargando plantillas…</p>
 ) : null}
 ...
 {meta ? (<div className="flex flex-wrap items-center justify-between gap-3 text-xs text-on-surface-muted">
 <span>
