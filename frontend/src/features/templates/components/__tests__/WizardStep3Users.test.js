...
import { searchTemplateReviewerCandidates, searchDocumentReviewerCandidates, fetchMe, } from '../../../../api/users';
...
describe('WizardStep3Users', () => {
    ...
    it('pasa exclude_user_id al buscar candidatos si hay templateCreatedBy', async () => {
        renderWithProfile(<WizardStep3Users {...defaultProps} validators={[]} templateCreatedBy="creator-uuid"/>);
        const searchInputs = screen.getAllByPlaceholderText('Filtrar usuarios...');
