...
export default function BlockNoteEditorPanel({ initialContent, editable, isDark, onChange }: Props) {
 ...
 return (<div className="flex-1 flex flex-col overflow-y-auto min-h-0 bg-white">
 {!editable && (<div className="mx-4 mt-3 px-3 py-2 text-xs text-on-surface-muted bg-surface rounded border border-outline">
 ...
 >
 {editable && (<div className="order-first sticky top-0 z-10 w-full border-b border-outline bg-surface-container-low/50 backdrop-blur-md px-2 py-1 shadow-sm">
 <FormattingToolbar />
 </div>
 )}
 </BlockNoteView>
