...
function ensureStyles() {
 ...
 el.textContent =`
 .bn-doc-content { font-family: system-ui, -apple-system, sans-serif; font-size: 16px; line-height: 1.8; color: var(--color-on-surface); }
 ...
 .bn-doc-content a { color: var(--color-primary); text-decoration: underline; }
 .bn-doc-content code { font-family: monospace; background: var(--color-surface); padding: 0.1em 0.35em; border-radius: 3px; font-size: 0.88em; }
 .bn-doc-content pre { background: var(--color-surface); padding: 1em 1.25em; border-radius: 6px; overflow-x: auto; margin: 0.75em 0; }
 .bn-doc-content blockquote { border-left: 3px solid var(--color-outline); margin: 0.75em 0; padding-left: 1em; color: var(--color-on-surface-variant); }
 .bn-doc-content table { border-collapse: collapse; width: 100%; margin: 1em 0; font-size: 0.9em; }
 .bn-doc-content th { background: var(--color-surface); font-weight: 600; text-align: left; }
 .bn-doc-content th, .bn-doc-content td { border: 1px solid var(--color-outline); padding: 0.5em 0.75em; }
 .bn-doc-content tr:nth-child(even) td { background: var(--color-surface); }
...
export function BlockContentHtml({ content }: { content: unknown[] }) {
 ...
 if (html === null) {
 return <div className="h-6 bg-surface animate-pulse rounded" />;
 }
