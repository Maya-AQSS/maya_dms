...
import { cloneTemplate as cloneTemplateRequest, createTemplate as createTemplateRequest, deleteTemplate as deleteTemplateRequest, fetchTemplates, updateTemplate as updateTemplateRequest, } from '../../../api/templates';
...
export function useTemplates() {
    ...
    const [filters, setFilters] = useState({ per_page: DEFAULT_PER_PAGE });
