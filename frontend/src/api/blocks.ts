...
export async function createBlock(templateId: string,
...
export async function updateBlock(blockId: string,
...
export async function bulkUpdateBlocks(payload: BulkUpdateBlockPayload,
...
export async function reorderBlocksForTemplate(templateId: string,
 blockIds: string[],
): Promise<void> {
