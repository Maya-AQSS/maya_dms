...
export function CascadeFilters({ onFilterChange, value }: CascadeFiltersProps) {
 ...
 if (loading) return <div className="text-sm text-on-surface-muted">Cargando filtros...</div>;
 ...
 className="md:hidden w-full flex items-center justify-between text-sm font-semibold text-on-surface"
 >
 <span>
